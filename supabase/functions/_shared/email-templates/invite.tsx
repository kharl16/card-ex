...
export default function InviteEmail({ siteName = 'Card-Ex', siteUrl = 'https://tagex.app', confirmationUrl = '', recipient = '' }: InviteEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              You've been invited to join Card-Ex — the platform for stunning digital business cards.
            </Text>
            <Text style={paragraph}>
