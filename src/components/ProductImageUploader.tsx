      ...
      <div className="mt-6 space-y-4 p-6 bg-card rounded-lg border border-border">
        <div className="space-y-2">
          ...
          <Input
            ...
            disabled={uploading}
            multiple
            className="flex items-center file:mr-0 file:px-2 file:py-2 file:rounded-md file:bg-[hsl(var(--gold))] file:text-[hsl(var(--primary-foreground))] file:font-medium file:border-0 file:cursor-pointer hover:file:bg-[hsl(var(--gold-hover))] disabled:opacity-50"
          />
