    ...
    switch (eyeStyle) {
      ...
      case "diamond":
        return (
          <svg viewBox="0 0 40 40" className={baseClass}>
            {/* Outer diamond */}
            <path d="M20 2 L38 20 L20 38 L2 20 Z" fill="none" stroke="currentColor" strokeWidth="3" />
            {/* Inner diamond */}
      ...
      case "star":
        return (
          <svg viewBox="0 0 40 40" className={baseClass}>
            ...
            />
            {/* Inner star */}
            <path d="M20 10 L22 16 L28 16 L23 20 L25 26 L20 22 L15 26 L17 20 L12 16 L18 16 Z" fill="currentColor" />
          </svg>
        );
      case "heart":
        return (
      ...
      case "shield":
        return (
          <svg viewBox="0 0 40 40" className={baseClass}>
            ...
            />
            {/* Inner shield */}
            <path d="M20 10 L28 13 L28 20 C28 25 24 28 20 30 C16 28 12 25 12 20 L12 13 L20 10 Z" fill="currentColor" />
          </svg>
        );
      case "soft-corner":
        return (
          <svg viewBox="0 0 40 40" className={baseClass}>
            {/* Outer soft-corner rounded frame */}
            <path
              d="M10 4 H26 A8 8 0 0 1 34 12 V28 A8 8 0 0 1 26 36 H10 A8 8 0 0 1 2 28 V12 A8 8 0 0 1 10 4 Z"
              fill="none"
              stroke="currentColor"
              strokeWidth="5"
              strokeLinecap="round"
            ...
            />
            {/* Inner rounded square, slightly offset toward the top-left */}
            <rect x="11" y="11" width="14" height="14" rx="4" fill="currentColor" />
          </svg>
        );
      default:
        return null;
